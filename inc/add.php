...
if($order == 3){
    $fioClient = $_POST["fioClient"];
    $pasportClient = $_POST["pasportClient"];
    $cars = $_POST["cars"];
    $classCars = $_POST["classCars"];
    ...
    $result = mysqli_query($connect, "INSERT INTO `testdrive` VALUES (NULL,CURDATE(),'$fioClient','$pasportClient','$cars','$classCars','$dataTest','$beforeTest','$afterTest','$fioResponsible')");
}
// $table = $_POST["table"];
// $items = $_POST["item"];
// $sring = "";
